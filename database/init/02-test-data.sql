...
VALUES 
-- Shot 1 - Driver
(1, 1, 'Driver', 152.3, 105.2, 13.5, 1.2, 2650, -2.1, 245.8, 267.3, 5.2, 31.4, 1.2, -0.8, -2.0, 1.2),
-- Shot 2 - Driver
(1, 2, 'Driver', 155.6, 106.8, 14.2, -0.7, 2450, 0.5, 255.3, 278.6, -3.8, 33.6, 1.5, 0.3, -1.2, 1.5),
-- Shot 3 - 7 Iron
(1, 3, '7 Iron', 115.3, 83.2, 17.8, 0.4, 6350, -3.2, 158.6, 162.7, 2.1, 29.8, -3.2, -1.5, 1.7, -3.2),
-- Shot 4 - 7 Iron
(1, 4, '7 Iron', 112.8, 81.5, 18.2, 0.9, 6580, -2.8, 153.2, 156.4, 3.4, 30.6, -2.9, -1.2, 1.7, -2.9),
-- Shot 5 - Pitching Wedge
(1, 5, 'PW', 90.3, 74.6, 25.3, -1.5, 8740, 1.2, 110.8, 112.3, -2.1, 25.7, -5.3, 0.8, 6.1, -5.3);
